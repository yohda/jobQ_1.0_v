				...
				<div class="col-md-8">
					...
					<div class="widget wgray">
						...
						<div class="widget-head">
							<div class="pull-left"><spring:message code="admin.main.employAndResume"/></div>
				...
				<div class="col-md-4">
					<div class=" widget wnavy">
						<div class="widget-head">
							...
							<div class="pull-left"><spring:message code="siteCurrent"/></div>
							<div class="widget-icons pull-right">
								<a href="#" class="wminimize"><i class="fa fa-chevron-up"></i></a>
								<a href="#" class="wclose"><i class="fa fa-times"></i></a>
							</div>
						...
						<div class="widget-content">
							<table class="table  table-bordered ">
								<tr>
									<td><spring:message code="allMembers"/></td>
									<td>${siteCurrentState.ALL_MEMBERS}</td>
								</tr>
								<tr>
									<td><spring:message code="companyRegDate"/></td>
									<td>2013-02-17</td>
								</tr>
								<tr>
									<td><spring:message code="allQnas"/></td>
									<td>${siteCurrentState.ALL_QNAS}</td>
								</tr>
								<tr>
									<td><spring:message code="allEmploys"/></td>
									<td>${siteCurrentState.ALL_EMPLOYS}</td>
								</tr>
								<tr>
									<td><spring:message code="allResumes"/></td>
									<td>${siteCurrentState.ALL_RESUMES}</td>
								</tr>
								<tr>
									<td><spring:message code="thisMonthNewMembers"/></td>
									<td>${siteCurrentState.NEW_MEMBERS}</td>
								</tr>
								<tr>
									<td><spring:message code="companyAddr"/></td>
			...
			<div class="row">
				...
				<div class="col-md-8">
					<div class="widget wred">
						<div class="widget-head">
							<div class="pull-left"><spring:message code="notice.title" /></div>
							<div class="widget-icons pull-right">
								<a href="#" class="wminimize"><i class="fa fa-chevron-up"></i></a>
								<a href="#" class="wclose"><i class="fa fa-times"></i></a>
							</div>
							...
							<div class="padd">
								<ul class="nav nav-tabs" role="tablist" id="myTab">
									<li role="presentation" class="active">
										<a href="#member" aria-controls="member" role="tab" data-toggle="tab"><spring:message code="notice.member" /></a>
									</li>

									<li role="presentation">
										<a href="#employ" aria-controls="employ" role="tab" data-toggle="tab"><spring:message code="notice.employ" /></a>
									</li>

									<li role="presentation">
										<a href="#apply-and-offer" aria-controls="apply-and-offer" role="tab" data-toggle="tab"><spring:message code="notice.applyAndOffer" /></a>
									</li>
									
									<li role="presentation">
										<a href="#resume" aria-controls="resume" role="tab" data-toggle="tab"><spring:message code="notice.resume" /></a>
									</li>
									
									<li role="presentation">
										<a href="#board" aria-controls="board" role="tab" data-toggle="tab"><spring:message code="notice.board" /></a>
									</li>
									
									<li role="presentation">
										<a href="#inquire" aria-controls="inquire" role="tab" data-toggle="tab"><spring:message code="notice.qna" /></a>
									</li>
								</ul>
						...
						<div class="widget-foot" style="text-align: center;">
							<a href="javascript:goList()"><spring:message code="btn.more" /></a>
						</div>
					</div>
				</div>
			</div>
