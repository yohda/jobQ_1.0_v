...
import org.antlr.grammar.v3.ANTLRParser.ebnf_return;
...
public class MemberEmailController {
	...
	public ResponseEntity<String> sendMail(@RequestBody String emailInfoJson){
		...
		try {
			...
			return new ResponseEntity<String>("INTERNAL_SERVER_ERROR : " + exception.getMessage(), HttpStatus.INTERNAL_SERVER_ERROR);
		}
