...
public class AdminNoticeController {
	...
	@Resource(name = "adminNoticeDelete")
	private JobqBoardDeleteTemplate jobqBoardDelete;
	...
	public ResponseEntity<String> deleteNotice(@RequestBody String deleteNumbers) throws Exception{
		try {
			boolean isDeleted = jobqBoardDelete.delete(JsonUtils.convertFromJson(deleteNumbers, List.class));
			if(isDeleted)
